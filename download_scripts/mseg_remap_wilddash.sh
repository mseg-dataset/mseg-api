...
# Remaps WildDash from 34-class task to 19-class task.

# Destination directory for WildDash
WILDDASH_DST_DIR=$1
NUM_CORES_TO_USE=$2
...
ORIG_DNAME="wilddash-34"
REMAP_DNAME="wilddash-19"

ORIG_DROOT=$WILDDASH_DST_DIR
